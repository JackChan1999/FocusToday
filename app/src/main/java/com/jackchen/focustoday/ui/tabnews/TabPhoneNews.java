 ...
 * ============================================================
 **/
public class TabPhoneNews extends BaseTabDetailPager {

    public TabPhoneNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getPhoneNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.PhoneId;
    }
