 ...
 * ============================================================
 **/
public class TabTechnologyNews extends BaseTabDetailPager {

    public TabTechnologyNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getTechnologyNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.TechnologyId;
    }
