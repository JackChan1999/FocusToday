 ...
 * ============================================================
 **/
public class TabEducationNews extends BaseTabDetailPager {

    public TabEducationNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getEducationNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.EducationId;
    }
