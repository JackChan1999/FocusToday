 ...
 * ============================================================
 **/
public class TabLotteryNews extends BaseTabDetailPager {

    public TabLotteryNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getLotteryNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.LotteryId;
    }
