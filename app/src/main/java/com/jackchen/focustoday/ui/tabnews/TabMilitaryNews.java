 ...
 * ============================================================
 **/
public class TabMilitaryNews extends BaseTabDetailPager {

    public TabMilitaryNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getMilitaryNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.MilitaryId;
    }
