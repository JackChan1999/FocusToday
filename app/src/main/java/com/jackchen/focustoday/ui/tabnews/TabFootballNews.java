 ...
 * ============================================================
 **/
public class TabFootballNews extends BaseTabDetailPager {

    public TabFootballNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getFootballNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.FootballId;
    }
}
