 ...
 * ============================================================
 **/
public class TabMobileNews extends BaseTabDetailPager {

    public TabMobileNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getMobileNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.MobileId;
    }
