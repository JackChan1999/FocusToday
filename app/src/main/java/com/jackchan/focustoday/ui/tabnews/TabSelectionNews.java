 ...
 * ============================================================
 **/
public class TabSelectionNews extends BaseTabDetailPager {

    public TabSelectionNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getSelectionNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.SelectionId;
    }
