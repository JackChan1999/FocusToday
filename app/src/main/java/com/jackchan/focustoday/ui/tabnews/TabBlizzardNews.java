 ...
 * ============================================================
 **/
public class TabBlizzardNews extends BaseTabDetailPager {

    public TabBlizzardNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getBlizzardNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.BlizzardId;
    }
