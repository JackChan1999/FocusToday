 ...
 * ============================================================
 **/
public class TabSocietyNews extends BaseTabDetailPager {

    public TabSocietyNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getSocietyNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.SocietyId;
    }
