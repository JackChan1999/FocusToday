 ...
 * ============================================================
 **/
public class TabDigitalNews extends BaseTabDetailPager {

    public TabDigitalNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getDigitalNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.DigitalId;
    }
