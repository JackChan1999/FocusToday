 ...
 * ============================================================
 **/
public class TabFunnyNews extends BaseTabDetailPager {

    public TabFunnyNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getFunnyNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.FunnyId;
    }
