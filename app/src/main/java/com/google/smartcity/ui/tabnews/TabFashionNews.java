 ...
 * ============================================================
 **/
public class TabFashionNews extends BaseTabDetailPager {

    public TabFashionNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getFashionNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.FashionId;
    }
