 ...
 * ============================================================
 **/
public class TabFinanceNews extends BaseTabDetailPager {

    public TabFinanceNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getFinanceNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.FinanceId;
    }
