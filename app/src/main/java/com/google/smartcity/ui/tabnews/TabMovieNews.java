 ...
 * ============================================================
 **/
public class TabMovieNews extends BaseTabDetailPager {

    public TabMovieNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getMovieNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.MovieId;
    }
