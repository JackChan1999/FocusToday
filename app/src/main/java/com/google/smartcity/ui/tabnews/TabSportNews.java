 ...
 * ============================================================
 **/
public class TabSportNews extends BaseTabDetailPager {

    public TabSportNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getSportNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.SportId;
    }
