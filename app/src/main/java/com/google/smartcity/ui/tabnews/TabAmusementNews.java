 ...
 * ============================================================
 **/
public class TabAmusementNews extends BaseTabDetailPager {

    public TabAmusementNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getAmusementNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.AmusementId;
    }
