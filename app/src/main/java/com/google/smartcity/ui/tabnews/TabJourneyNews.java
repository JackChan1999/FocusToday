 ...
 * ============================================================
 **/
public class TabJourneyNews extends BaseTabDetailPager {

    public TabJourneyNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getJourneyNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.JourneyId;
    }
