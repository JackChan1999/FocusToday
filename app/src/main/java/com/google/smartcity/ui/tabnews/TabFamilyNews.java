 ...
 * ============================================================
 **/
public class TabFamilyNews extends BaseTabDetailPager {

    public TabFamilyNews(Activity activity) {
        super(activity);
    }

    @Override
    public String getNewsUrl(int index) {
        return RequestUrl.getFamilyNewsUrl(index);
    }

    @Override
    public String getNewsId() {
        return RequestUrl.FamilyId;
    }
