...
public class MediaController extends FrameLayout {
  ...
  private void updatePausePlay() {
    ...
    if (mPlayer.isPlaying())
      mPauseButton.setImageResource(getResources().getIdentifier("video_player_pause", "mipmap", mContext.getPackageName()));
    else
      mPauseButton.setImageResource(getResources().getIdentifier("video_player_play", "mipmap", mContext.getPackageName()));
  }
